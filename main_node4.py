...
def main():
    ...
    available_chunks = {i: file_chunks[i] for i in range(12, 16) if i < len(file_chunks)}
...
if __name__ == '__main__':
    node_4_chunks = [chunk_file('file_to_share.txt', 512)[i] for i in range(12, 16) if i < len(chunk_file('file_to_share.txt', 512))]
